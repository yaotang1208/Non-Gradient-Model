...
figure(46);
subplot(3,1,1);
plot(1:1:DaysAYear, C_OBS_DM,1:1:DaysAYear, Cw_S_DM,1:1:DaysAYear, Cw_N_DM);grid on;
...
legend('HOD','OBS');
xlabel('DOY');
ylabel('Daily Mean Fw (mmol m^{-2} s^{-1})');
subplot(3,1,3);
scatter(F_OBS_DM, F_HOD_DM);grid on;
xlabel('OBS Daily Mean Fw (mmol m^{-2} s^{-1})');
ylabel('HOD Daily Mean Fw (mmol m^{-2} s^{-1})');
axis('square');
...
legend('HOD','OBS');
ylabel('Fw (mmol m^{-2} s^{-1})');
subplot(3,1,3);
scatter(F_OBS_DC,F_HOD_DC);
xlabel('OBS Fw (mmol m^{-2} s^{-1})');
ylabel('HOD Fw (mmol m^{-2} s^{-1})');
axis('square');
...
figure(48);
subplot(3,1,1);
plot(1:1:Month, C_OBS_MM,1:1:Month, Cw_S_MM,1:1:Month, Cw_N_MM);grid on;
legend('OBS','Saturated','Unsaturated');
ylabel('H2O (\mumol/mol)');
subplot(3,1,2);
...
figure(49);
subplot(3,1,1);
plot(X_MMDC, C_OBS_MMDC_V,X_MMDC, Cw_S_MMDC_V,X_MMDC, Cw_N_MMDC_V);grid on;
legend('OBS','Saturated','Unsaturated');
ylabel('H2O (mmol/mol)');
subplot(3,1,2);
...
plot(X_month,F_HOD_AMDT_mm,'-ok',X_month,F_OBS_AMDT_mm,'--om',...
    ...
    X_month,F_HOD_AM_mm,'-^g',X_month,F_OBS_AM_mm,'--^b','LineWidth',1.5,'MarkerSize',12);grid on;
