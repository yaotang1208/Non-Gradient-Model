...
CwN_BRSa1 = CwN;
SWC_BRSa1 = SWC_DP;
Fw_HOD_BRSa1 = FH2O_HOD;
Fw_OBS_BRSa1 = FH2O_OBS;
Fw_HOD_DC_BRSa1 = F_HOD_DC_H2O;
Fw_OBS_DC_BRSa1 = F_OBS_DC_H2O;
CO2_BRSa1 = CO2_DP;
Fc_HOD_BRSa1 = FCO2_HOD;
Fc_OBS_BRSa1 = FC_DP;
Fc_HOD_DC_BRSa1 = F_HOD_DC_CO2;
Fc_OBS_DC_BRSa1 = F_OBS_DC_CO2;
RecordsADay_BRSa1 = RecordsADay;
PREC_BRSa1 = PREC_DP;
WS_BRSa1 = WS_DP;
UST_BRSa1 = UST_DP;
RH_BRSa1 = RH_DP;

save('BRSa1_TenDay.mat','T_BRSa1','Ta_BRSa1','CwS_BRSa1','CwN_BRSa1',...
    'SWC_BRSa1','Fw_HOD_BRSa1','Fw_OBS_BRSa1','Fw_HOD_DC_BRSa1',...
    'Fw_OBS_DC_BRSa1','CO2_BRSa1','Fc_HOD_BRSa1','Fc_OBS_BRSa1',...
    'Fc_HOD_DC_BRSa1','Fc_OBS_DC_BRSa1','RecordsADay_BRSa1',...
    'PREC_BRSa1','WS_BRSa1','UST_BRSa1','RH_BRSa1')

%% MEP vs. HOD
EMEP_BRSa1 = EMEP;
save('BRSa1_EMEP.mat','EMEP_BRSa1');
